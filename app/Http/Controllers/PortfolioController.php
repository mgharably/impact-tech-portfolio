...
class PortfolioController {
 public function home(){return view('home',['settings'=>Setting::pluck('value','key'),'services'=>Service::where('published',true)->orderBy('sort_order')->get(),'projects'=>Project::where('published',true)->orderBy('sort_order')->get()]);}
