...
Route::get('/{type}/create',[AdminController::class,'edit'])->whereIn('type',['services','projects','team']);
Route::get('/{type}/{id}/edit',[AdminController::class,'edit'])->whereIn('type',['services','projects','team'])->whereNumber('id');
Route::post('/{type}',[AdminController::class,'save'])->whereIn('type',['services','projects','team']);
Route::put('/{type}/{id}',[AdminController::class,'save'])->whereIn('type',['services','projects','team'])->whereNumber('id');
Route::delete('/{type}/{id}',[AdminController::class,'delete'])->whereIn('type',['services','projects','team'])->whereNumber('id');
});
